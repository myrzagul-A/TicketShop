...
namespace eTicketShop.Data.Cart
{
    public class ShoppingCart
    {
        ...
        public void AddItemToCart(Event @event)
        {
...
public double GetShoppingCartTotal() => _context.ShoppingCartItem.Where(n => n.ShoppingCartId == ShoppingCartId).Select(n => n.Event.Price * n.Amount).Sum();
